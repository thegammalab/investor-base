		...
		<div class="menu_div" id="tabs">
			...
			<h2 class="nav-tab-wrapper" style="height:34px">
				<ul>
					...
					<li style="margin-left:9px"><a style="margin:0; height: 23px" class="nav-tab" href="#tabs-5"><?php _e( 'Recent Facebook Comments', 'fancy-facebook-comments' ) ?></a></li>
					<li style="margin-left:9px"><a style="margin:0; height:23px" class="nav-tab" href="#tabs-6"><?php _e( 'Shortcode and Widget', 'fancy-facebook-comments' ) ?></a></li>
					<li style="margin-left:9px"><a style="margin:0; height:23px" class="nav-tab" href="#tabs-7"><?php _e( 'FAQ', 'fancy-facebook-comments' ) ?></a></li>
				</ul>
			</h2>
