    ...
    <div class="container">
        <div class="row" style="">
            ...
            <div class="col-xs-12" style="text-align: center;margin-top: 10px;">
                ...
                <h1 class="title-margin" style="margin-bottom: 0;"><span style="background: #FFF; padding: 0 20px;"><?php echo apply_filters("tdf_get_display_name",$author->ID); ?></span></h1>
                    ...
                    <div class="col-xs-4 review_item">
                        <div class="row">
                            ...
                            <div class="col-xs-8" style="text-align: left;">
                                <h3 class="user-name" style="padding-left: 0;"><a href="<?php echo get_author_posts_url($uid); ?>"><?php echo apply_filters("tdf_get_display_name",$uid); ?></a></h3>
